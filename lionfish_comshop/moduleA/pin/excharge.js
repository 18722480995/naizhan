...
Page({
            ...
            success: function(t) {
                if (wx.hideLoading(), 0 == t.data.code) {
                    ...
                    s.setData({
                        ...
                        items: n,
                        type: e,
                      commiss_tixian_publish: a.replace('< img ', '< img style="max-width:100%;height:auto;display:block;margin:10px 0;"')
                    })
                } else wx.showModal({
                    title: "提示",
                    content: t.data.msg,
    ...
    formSubmit: function(t) {
        ...
        if (1 != n) {
            ...
            var c = this.data,
                ...
                u = c.info.money,
                h = parseFloat(c.info.commiss_min_tixian_money);
            if ("" == r || r < h) return wx.showToast({
                title: "最小提现" + h + "元",
                icon: "none"
            }), !1;
            if (u < r) {
    ...
    bindTixianMoneyInput: function(t) {
        ...
        var i = (n * (100 - this.data.info.commiss_tixian_bili) / 100).toFixed(2),
            e = !1;
