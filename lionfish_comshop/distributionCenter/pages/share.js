...
Page({
            ...
            success: function(e) {
                if (0 == e.data.code) {
                    ...
                    if (0 < e.data.commiss_level) {
                        var a = 1 * e.data.commiss_share_member_update,
                            s = 1 * e.data.share_member_count,
                            i = 1 * e.data.commiss_share_member_update - 1 * e.data.share_member_count,
                            o = e.data.commiss_diy_name || "分销";
  ...
  onShareTimeline: function () {
      ...
      return console.log(e, t), {
        title: "",
        query: "community_id=" + e + "&share_id=" + t,
        imageUrl: "",
      }
    }
});