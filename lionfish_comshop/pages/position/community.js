...
Page({
    ...
    load_gps_community: function() {
        var t = wx.getStorageSync("token"),
            e = wx.getStorageSync("tx_map_key");
        if (null == e || "" == e) {
        ...
        t && app.util.request({
            ...
            success: function(t) {
                if (0 == t.data.code) {
                    var e = t.data.list,
                        a = !1;
                    0 != Object.keys(e).length && 0 != e.communityId || (a = !0), i.data.community && (app.globalData.community = e), i.setData({
                        historyCommunity: e,
                        isNotHistory: a
                    })
                }
    ...
    load_gps_community_list: function(t) {
        var e = wx.getStorageSync("token"),
            a = this;
      a.data.hasRefeshin || (wx.showLoading({
        title: "加载中...",
        mask: !0,
        icon: "none"
      }),a.setData({
    ...
    onShow: function() {
        if (console.log("show"), this.isFirst) this.isFirst = !1;
        else {
            var t = wx.getStorageSync("city"),
                e = wx.getStorageSync("city_id");
