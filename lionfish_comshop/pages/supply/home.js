...
Page({
    ...
    page: 1,
    onLoad: function(t) {
        this.supplyId = t.id || 0, "undefined" != t.share_id && 0 < t.share_id && wcache.put("share_id", t.share_id), this.getData()
    },
    ...
    onShareAppMessage: function(t) {
        var a = this.data.info.storename || "供应商主页",
            e = wx.getStorageSync("member_id");
        return {
            title: a,
            path: "lionfish_comshop/pages/supply/home?id=" + this.supplyId + "&share_id=" + e,
            success: function(t) {},
            fail: function(t) {}
        }
    },
  onShareTimeline: function (t) {
    ...
    return {
      title: a,
      query: "id=" + this.supplyId + "&share_id=" + e,
    }
  }
});